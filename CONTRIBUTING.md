...
Have an idea to make the Booking App better? Open an issue with the "enhancement" tag and describe the feature you'd like to see.
...
### Sugerir Mejoras 💡
¿Tienes una idea para hacer que Booking App sea mejor? Abre un "Issue" con la etiqueta "enhancement" y describe la funcionalidad que te gustaría ver.
